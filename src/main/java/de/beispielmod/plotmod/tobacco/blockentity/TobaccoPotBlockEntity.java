...
import de.beispielmod.plotmod.tobacco.data.TobaccoPotData;
...
public class TobaccoPotBlockEntity extends BlockEntity {
    ...
    public void load(CompoundTag tag) {
        ...
        if (tag.contains("Plant")) {
            ...
            var plant = potData.getPlant();
            if (plant != null) {
                plant.setQuality(de.beispielmod.plotmod.tobacco.TobaccoQuality.valueOf(plantTag.getString("Quality")));
