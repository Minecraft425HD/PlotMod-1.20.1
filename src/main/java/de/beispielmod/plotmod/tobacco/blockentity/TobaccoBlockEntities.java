...
public class TobaccoBlockEntities {
    ...
    // ═══════════════════════════════════════════════════════════
    // NEUE FEATURES: ARBEITER-SCHRANK
    // ═══════════════════════════════════════════════════════════
    
    public static final RegistryObject<BlockEntityType<WorkerStorageBlockEntity>> WORKER_STORAGE = 
        BLOCK_ENTITIES.register("worker_storage", () -> 
            BlockEntityType.Builder.of(WorkerStorageBlockEntity::new,
                TobaccoBlocks.WORKER_STORAGE.get()
            ).build(null));
}
