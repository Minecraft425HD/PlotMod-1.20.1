package de.beispielmod.plotmod.economy.events;
...
public class CashSlotRestrictionHandler {
    ...
    private static final int CASH_SLOT = 8; // Slot 8 = Hotbar Slot 8 (ganz rechts)
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        if (!(slot8.getItem() instanceof CashItem)) {
            ...
            player.displayClientMessage(Component.literal(
                ...
                "§7Die Geldbörse ist in Slot 8 gesperrt.\n" +
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (heldItem.getItem() instanceof CashItem) {
            ...
            if (slot != CASH_SLOT) {
                ...
                player.displayClientMessage(Component.literal(
                    "§c✗ Geldbörse kann nur in Slot 8 verwendet werden!"
                ), true);
            }
        }
    }
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent event) {
        ...
        if (slot8.isEmpty() || !(slot8.getItem() instanceof CashItem)) {
            ...
            if (foundWallet != null) {
                ...
                player.displayClientMessage(Component.literal(
                    "§e⚠ Geldbörse wurde zurück zu Slot 8 verschoben!"
                ), true);
            } else {
